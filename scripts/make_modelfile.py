#!/usr/bin/env python
"""Write (or check) the Ollama Modelfile generated from the training system prompt.
...
from bql_lora.modelfile import DEFAULT_GGUF, SYSTEM_CHOICES, render_modelfile  # noqa: E402
...
def main() -> int:
    ...
    text = render_modelfile(args.gguf, args.system)
    if args.check:
